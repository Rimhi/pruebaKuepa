            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="programa" class="col-md-4 col-form-label text-md-right">{{ __('Programa') }}</label>

                            <div class="col-md-6">
                            <select name="program_id" class="form-control" id="programa_id">
                                @foreach($programs as $program)
                                <option value="{{$program->id}}" class="form-control">{{$program->name}}</option>
                                @endforeach
                                </select>
